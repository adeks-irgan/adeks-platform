...
| **K-17 — F&B price source for settlement** | `/docs/KEREM_DECISIONS.md` §17 | **Locked — Kerem-approved 2026-06-14.** Settlement uses price captured at order submission (immutable snapshot); catalog edits after submission do not affect settlement amount. Resolves dependency D-4. Pod C remains blocked (ADR-006 Accepted; ADR-007 Backlog). |
