...
| Auth | `/docs/PROJECT_METHODOLOGY.md`; `/docs/PROJECT_DECISION_INDEX.md`; `/docs/USER_ROLES_AND_PERMISSIONS.md`; `/docs/SECURITY_REVIEW.md`; `/docs/architecture/SECURITY_VIEW.md`; `/docs/architecture/AUTHENTICATION_RECOMMENDATION_OQ-001.md`; `/docs/adr/ADR-015-authentication-strategy.md` | mixed: methodology, decision index, `USER_ROLES_AND_PERMISSIONS.md`, `AUTHENTICATION_RECOMMENDATION_OQ-001.md`, and `ADR-015-authentication-strategy.md` exist; security architecture files are planned | If security files or auth ADR are absent, do not create implementation issue; request Pod B review and produce missing product-role input first. | A, B, C | Pod B; Kerem if customer-data or admin-policy impact exists | Yes |
