...
<<<<<<< HEAD
| Auth | `/docs/PROJECT_METHODOLOGY.md`; `/docs/PROJECT_DECISION_INDEX.md`; `/docs/USER_ROLES_AND_PERMISSIONS.md`; `/docs/SECURITY_REVIEW.md`; `/docs/architecture/SECURITY_VIEW.md`; `/docs/architecture/AUTHENTICATION_RECOMMENDATION_OQ-001.md`; relevant auth ADR if created | mixed: methodology, decision index, `USER_ROLES_AND_PERMISSIONS.md`, and `AUTHENTICATION_RECOMMENDATION_OQ-001.md` exist; security architecture files are planned | If role/permission or security files are absent, do not create implementation issue; request Pod B review and produce missing product-role input first. | A, B, C | Pod B; Kerem if customer-data or admin-policy impact exists | Yes |
=======
| Auth | `/docs/PROJECT_METHODOLOGY.md`; `/docs/PROJECT_DECISION_INDEX.md`; `/docs/USER_ROLES_AND_PERMISSIONS.md`; `/docs/SECURITY_REVIEW.md`; `/docs/architecture/SECURITY_VIEW.md`; `/docs/architecture/AUTHENTICATION_RECOMMENDATION_OQ-001.md`; relevant auth ADR if created | mixed: methodology, decision index, `USER_ROLES_AND_PERMISSIONS.md`, and `AUTHENTICATION_RECOMMENDATION_OQ-001.md` exist; security architecture files and auth ADR are planned | If security files or auth ADR are absent, do not create implementation issue; request Pod B review and produce missing product-role input first. | A, B, C | Pod B; Kerem if customer-data or admin-policy impact exists | Yes |
>>>>>>> fd2fbf1 (docs: reconcile auth manifest after PR 37)
