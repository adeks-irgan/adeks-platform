...
| `gitcc` | One complete Codex-ready prompt in its own file. It must include: `show diff before commit`. Do not include post-execution review handoff text in this file. |
